...
bao.books = (() => {
  ...
  var data = [
    ...
    ['文学', 'Charles Dickens', 'A Christmas Carol / The Chimes / The Cricket on the Hearth', publishers.barnes, 2004, 1, 
      '978-1593080334', 304, 6, '2020-10-25', '2021-03-14', ''],
    ...
    ['文学', 'John R. Tolkien', 'The Hobbit', publishers.houghton, 2002, 1,
      '978-0618260300', 366, 8, '2019-07-15', '2019-10-15', ''],
    ...
    ['文学', 'Harper Lee', 'To Kill a Mockingbird', 'Grand Central', 2010, 1, '978-0446310789', 376, 9, '2020-10-10', '2020-10-24', 'mockingbird/mockingbird'],
